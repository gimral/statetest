...
public class WindowWatermarkTest {
    ...
    public static void main(String[] args) {
        ...
        p.apply(GenerateSequence.from(0).withRate(1, Duration.standardSeconds(1)))
                ...
                .apply("Watermark", ParDo.of(new DoFn<KV<Long, Long>, KV<Long, Long>>() {
//                    @StateId("state")
//                    private final StateSpec<ValueState<Long>> leftState = StateSpecs.value();
                    ...
                    public void process(
                        ...
                        //System.out.println(ts.toDateTime());
                        ...
                        //Instant expirationTime = new Instant(c.timestamp()).minus(Duration.standardSeconds(5));
                        c.output(c.element());
                        //Long k = state.read();
//                        if(k==null)
//                            k = 0L;
//                        state.write(++k);
                        ...
                        //c.outputWithTimestamp(c.element(),expirationTime);
                        gcTimer.offset(Duration.standardSeconds(2)).setRelative();
...
//                        }
                        //state.clear();
                        c.fireTimestamp();
                        System.out.println(c.fireTimestamp());
